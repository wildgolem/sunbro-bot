		...
		if (!newVoiceState.member.user.bot) {
			...
			if (newVoiceState.channel && oldVoiceState.channelId !== newVoiceState.channelId) {
				...
				if (newVoiceState.member.user.id === khang) {
					...
					resource = voiceDiscord.createAudioResource('https://cdn.discordapp.com/attachments/979172537193877504/980665322501734490/fuck_you_cody.mp3', { inlineVolume: true });
				}
